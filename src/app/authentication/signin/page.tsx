    ...
    <div className="min-h-screen bg-[#061e29] flex items-center justify-center px-4 py-12">
      <div className="bg-[#083344] p-8 rounded-2xl border border-[#06b6d4]/20 shadow-2xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#bae6fd]/70 mt-2 text-sm">Please login to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <div className="text-right mt-1">
              <Link href="#" className="text-sm text-[#22d3ee] hover:underline">Forgot password?</Link>
            </div>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#083344] text-[#bae6fd]/60">Or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-[#bae6fd]/60 mt-8 border-t border-[#06b6d4]/20 pt-6">
          Don't have an account? <Link href="/authentication/register" className="text-[#22d3ee] hover:underline font-bold">Register here</Link>
        </p>
      </div>
    </div>
  );
